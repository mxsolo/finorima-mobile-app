...
//
//
//  Copyright © Finorima. All rights reserved.
//
...
class AppDelegate: UIResponder, UIApplicationDelegate, GADInterstitialDelegate {
    ...
    static let CONFIG = "https://finorima.com/mobile-configs/ios-config.json"

    /**
     * Layout options
     */
    static let APP_THEME_LIGHT = true
    static let APP_THEME_COLOR = UIColor(red: 0.41, green: 1.00, blue: 0.23, alpha: 1.0)
     ...
     * About / Texts
     **/
    static let NO_CONNECTION_TEXT = "Unable to connect to the server. Make sure you have a working internet connection."
    static let ABOUT_TEXT = "Thank you for downloading Finorima. \n\nIf you need any help, press the button below to visit our support."
    static let ABOUT_URL = "https://finorima.com/feed/terms/about-us"
    static let PRIVACY_POLICY_URL = "https://finorima.com/feed/terms/privacy-policy"
     ...
     * API Keys
     **/
    static let ONESIGNAL_APP_ID = "228b5e2a-2311-40fc-92f7-eba98ca1fcdb"

    static let MAPS_API_KEY = ""

    static let VIMEO_API = ""
    ...
    static let SOUNDCLOUD_CLIENT_SECRET = ""
     ...
     * WooCommerce
     **/
    static let WOOCOMMERCE_HOST = "http://finorima.com/"
    static let WOOCOMMERCE_KEY = ""
    static let WOOCOMMERCE_SECRET = ""
